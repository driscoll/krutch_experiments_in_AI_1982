1 REM CHECKERS, Vers. 1.1

10 REM Supervisor
20 GOSUB 130 :REM Initialization
30 GOSUB 230 :REM Set array to initial piece configuration
40 GOSUB 970 :REM Computer's first move
50 GOSUB 450 :REM Draw checkerboard
60 GOSUB 570 :REM Print nos on squares & crnt arngmt pieces
70 GOSUB 780 :REM Input
80 GOSUB 840 :REM Change array to reflect new posn of pieces
90 GOSUB 570
100 IF M$ = "X" THEN GOTO 70 :REM Double and triple jumps
110 GOSUB 1040 :REM Evaluatino routine
120 GOTO 60
...
1220 NEXT J, I
1230 REM C. Black looking for a move which won't result 
1240 REM in a capture
1250 FOR I = 2 TO 9
1260 FOR J = 2 TO 9
